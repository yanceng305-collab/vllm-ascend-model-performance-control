...
**Current GLM profile governance:** `FORMAL_CANDIDATE_ACCEPTANCE_PASS`
...
- **Profile-Candidate Full-Matrix Evidence Review PASS (2026-09-07)**: Release `glm52-od-profile-full-matrix-20260903` (id 382481190; asset id 543798263, digest `01eb1b5f7163fe52956483fae2316851e4fcdaaa064c43301af3c69deb94ee03`, sidecar id 543798262) reviewed at dispatch SHA `2711b6ed366d84187a1102b60186d42c5ba198cd` — Release provenance, archive digest, SHA256SUMS 92/92, control-sha, pinned tooling, 16 raw-log re-extraction, per-cell validators x4, matrix validator, frozen-profile values ALL PASS. Machine means (tok/s): 1K 1205.09, 4K 1629.65, 16K 1935.69, 64K 1766.37; normalized achievements 117.9 / 105.5 / 116.3 / 91.9 (all >= 80%); 12 measured / 4 discarded. **Candidate `0.95 / 67000 = FINAL_RECOMMENDED_PROFILE_CANDIDATE`** (not a Formal Result). Next stage: `MACHINE-GENERATED FORMAL CANDIDATE RESULT STAGE`. No Acceptance yet; Formal OPT-01 remains BLOCKED_PENDING_BASELINE_VALUE_VERIFICATION.
